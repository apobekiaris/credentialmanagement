...
namespace CredentialManagement.Test
{
    ...
    public class XPPromptTests
    {
        ...
        [TestMethod]
        public void CredentialsPrompt_ShouldImplement_IDisposable()
        {
            Assert.IsTrue(new XPPrompt() is IDisposable, "CredentialsPrompt should implement IDisposable interface.");
        }
        ...
        [TestMethod]
        public void CredentialsPrompt_Target_NullValue()
        {
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_Without_Target_ShouldThrowError()
        {
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_AlwaysShowUI()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_AlwaysShowUI_Without_GenericCredentials_ShouldThrowError()
        {
            XPPrompt prompt = GetDefaultPrompt();
            prompt.AlwaysShowUI = true;
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_CompleteUsername()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_DoNotPersist()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_ExcludeCertificates()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_ExpectConfirmation()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_IncorrectPassword()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_Persist()
        {
            XPPrompt prompt = GetDefaultPrompt();
            prompt.Persist = true;
            prompt.ShowDialog(IntPtr.Zero);
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_RequestAdministrator()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_RequreCertificate()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_RequreSmartCard()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_UsernameReadOnly()
        {
            XPPrompt prompt = GetDefaultPrompt();
        ...
        [TestMethod]
        public void CredentialsPrompt_ShowDialog_ValidateUsername()
        {
            XPPrompt prompt = GetDefaultPrompt();
